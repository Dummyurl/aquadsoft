            ...
            <ul class="list">
                ...
                <li>
                    <a href="javascript:void(0);" class="menu-toggle">                        
                        <span><i class="fa fa-sitemap" aria-hidden="true"></i> Downline Graphical View</span>
                    </a>
                    <ul class="ml-menu">
                        <li>
                            <a href="<?php echo base_url('tree'); ?>"><i class="fa fa-share-alt" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Genealogy Tree</a>
                        </li>
                        <li>
